...
function animation() {
    ...
    document.querySelector('#btn-animation-gf-1').onclick = function() {
        ...
        var icon = 'success';
        var icon = 'info';
        var msg = ['当前时间： ' , new Date(), new Date(), new Date(), new Date(), new Date(), new Date(), new Date(), new Date(), new Date(), new Date(), new Date()];
