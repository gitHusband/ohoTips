...
(function () {
            ...
            if(icon === true) {
                ...
                switch(icon) {
                    ...
                    case "info" :
                        ...
                        break;
                    case "clock" :
                        iconClass = iconClass + " icon-clock icon-info";
                        break;
                    default:
                        iconClass = icon;
                        break;
    ...
    tips.prototype.getTipsContainer = function(options) {
        ...
        // let $tipContainer = $tipGroup.parent("div[name^='tipContainer-']");
    ...
    tips.prototype.renderTipsBody = function(options) {
        ...
        $parent.appendChild($tipContainer);         //先插入元素，然后才能获取宽度和高度
    ...
    tips.prototype.getElementDetails = function() {
        ...
        if(!this.options.parentElement || this.backup._pElem.tagName == 'BODY') {
            details = {
    ...
    tips.prototype.getPositionClass = function(myPosition) {
        ...
        if(!this.options.parentElement || this.backup._pElem.tagName == 'BODY') {
            positionClass.tipClass = "ohoTip-fixed";      //注意空格
    ...
    tips.prototype.getPositionStyle = function(myPosition, calculateTip, force) {
        ...
        if(((!this.options.parentElement || this.backup._pElem.tagName == 'BODY') && typeof myPosition == "string") && !force) {
            return {};
        }
        ...
        if(typeof myPosition == "string") {
            ...
            // if(myPosition.hasOwnProperty('top') && !myPosition.hasOwnProperty('bottom') && C.isEmptyNum(myPosition.top)) myPosition.top = 0;
            // if(myPosition.hasOwnProperty('bottom') && C.isEmptyNum(myPosition.bottom)) myPosition.bottom = 0;
            // if(myPosition.hasOwnProperty('left') && !myPosition.hasOwnProperty('right') && C.isEmptyNum(myPosition.left)) myPosition.left = 0;
            // if(myPosition.hasOwnProperty('right') && C.isEmptyNum(myPosition.right)) myPosition.right = 0;
            ...
            if(myPosition.hasOwnProperty('bottom') && regNum.test(myPosition.bottom)) {
                ...
                // tipPosition.top = C.numSubs(C.numAdds(eleDetails.pTop, eleDetails.pBTWid, eleDetails.pHeight), tipGroupHeight, parseFloat(myPosition.bottom));
                ...
                // let bottom = C.numMul(C.numSub(eleDetails.pTop , eleDetails.pBTWid), C.numDiv(parseFloat(myPosition.bottom), 100));
                // tipPosition.top = C.numSubs(C.numAdds(eleDetails.pTop , eleDetails.pBTWid , eleDetails.pHeight), tipGroupHeight , bottom);
                ...
                // tipPosition.top = C.numAdds(eleDetails.pTop, eleDetails.pBTWid, parseFloat(myPosition.top));
                ...
                // let top = C.numMul(C.numSub(eleDetails.pHeight, tipGroupHeight), C.numDiv(parseFloat(myPosition.top), 100));
                // tipPosition.top = C.numAdds(eleDetails.pTop, eleDetails.pBTWid, top);
            }
            ...
            if(myPosition.hasOwnProperty('right') && regNum.test(myPosition.right)) {
                ...
                // tipPosition.left = C.numSubs(C.numAdds(eleDetails.pLeft , eleDetails.pBLWid , eleDetails.pWidth), tipGroupWidth , parseFloat(myPosition.right))
                ...
                // let right = C.numMul(C.numSub(eleDetails.pWidth , tipGroupWidth), C.numDiv(parseFloat(myPosition.right) , 100));
                // tipPosition.left = C.numSubs(C.numAdds(eleDetails.pLeft , eleDetails.pBLWid , eleDetails.pWidth), tipGroupWidth , right);
                ...
                // tipPosition.left = C.numAdds(eleDetails.pLeft , eleDetails.pBLWid , parseFloat(myPosition.left));
                ...
                // let left = C.numMul(C.numSub(eleDetails.pWidth , tipGroupWidth), C.numDiv(parseFloat(myPosition.left) , 100));
                // tipPosition.left = C.numAdds(eleDetails.pLeft , eleDetails.pBLWid , left);
            }
            ...
            if(this.options.direction == 'normal') {
                if(myPosition.hasOwnProperty('bottom')  && regNum.test(myPosition.bottom)) {
                    ...
                    // tipPosition.top = C.numAdds(eleDetails.pTop, eleDetails.pHeight, eleDetails.pBTWid, eleDetails.pBBWid, parseFloat(myPosition.bottom));
                }else if(myPosition.hasOwnProperty('bottom') && regPer.test(myPosition.bottom)) {
            ...
            }else if(this.options.direction == 'outer') {
                if(myPosition.hasOwnProperty('bottom') && regNum.test(myPosition.bottom)) {
    ...
    tips.prototype.animationTypeOho = function(status) {
        ...
        if(status == 'in') {
            ...
            setTimeout(function(){
                C.addClass($tipGroup, 'ohoTip-amt-A');
            ...
            setTimeout(function(){
                ...
                C.removeClass($tipGroup, 'ohoTip-amt-A');
